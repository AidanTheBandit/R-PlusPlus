...
const base = (size = 18, stroke = 1.75) => ({
...
export const WidgetsIcon = ({ size, className }) => (
  <svg {...base(size)} className={className}>
...
export const SpeechIcon = ({ size, className }) => (
  <svg {...base(size)} className={className}>
...
export const ApiDocsIcon = ({ size, className }) => (
  <svg {...base(size)} className={className}>
...
export const MicIcon = ({ size, className }) => (
  <svg {...base(size)} className={className}>
    <path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/>
    <path d="M19 10v2a7 7 0 0 1-14 0v-2"/>
    <line x1="12" y1="19" x2="12" y2="23"/>
...
export const BotIcon = ({ size, className }) => (
  <svg {...base(size)} className={className}>
...
export const VolumeIcon = ({ size, className }) => (
  <svg {...base(size)} className={className}>
