...
import { VolumeIcon, MusicIcon, XIcon, CheckIcon, InfoIcon, WrenchIcon } from './Icons';
...
const SpeechTest = ({ deviceId, pinCode }) => {
  ...
  return (
    <div className="speech-test">
      <div className="card">
        <h2 className="section-title"><MusicIcon size={22} /> Text-to-Speech Test</h2>
        ...
        <div className="action-buttons">
          ...
          >
            {isLoading ? <><VolumeIcon size={16} /> Generating Speech...</> : <><VolumeIcon size={16} /> Test Speech</>}
          </button>
        </div>
