...
function setupMCPRoutes(app, io, connectedR1s, mcpManager, deviceIdManager) {
  ...
  // Debug endpoint to check device state - REMOVED: Leaks device IDs and sensitive data
  ...
  // Debug endpoint to manually test chat completion - REMOVED: Allows unauthorized control of devices
